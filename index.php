	...
	<main>
			...
			<div class="swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="hero-side" style="background-image: url(assets/img/home/hero/hero10.webp)"
							fetchpriority="high">
							<div class="container">
								<div class="row">
									<div class="col-xl-12">
										<div class="hero-content-1">
											...
											<div class="text" data-animation="animate__fadeInUp" data-delay="0.5s">
												<p><?php echo frontend_escape($contentText('home.hero.slide1.text')); ?>
												</p>
											</div>
											<div class="join-us" data-animation="animate__fadeInUp" data-delay="0.6s">
												...
												<div class="author-wrap">
													...
													<div class="author-info">
														<h5>50k+</h5>
														<p><?php echo frontend_escape($contentText('home.hero.supporters.label')); ?>
														</p>
													</div>
												</div>
											</div>
					...
					<div class="swiper-slide">
						<div class="hero-side" style="background-image: url(assets/img/home/hero/hero6.webp)"
							fetchpriority="high">
							<div class="container">
								<div class="row">
									<div class="col-xl-12">
										<div class="hero-content-1">
											...
											<div class="text" data-animation="animate__fadeInUp" data-delay="0.5s">
												<p><?php echo frontend_escape($contentText('home.hero.slide2.text')); ?>
												</p>
											</div>
											<div class="join-us" data-animation="animate__fadeInUp" data-delay="0.6s">
												<a class='e-primary-btn has-icon' href='about.php'>
					...
					<div class="swiper-slide">
						<div class="hero-side" style="background-image: url(assets/img/home/hero/hero7.webp)"
							fetchpriority="high">
							<div class="container">
								<div class="row">
									<div class="col-xl-12">
										<div class="hero-content-1">
											...
											<div class="text" data-animation="animate__fadeInUp" data-delay="0.5s">
												<p><?php echo frontend_escape($contentText('home.hero.slide3.text')); ?>
												</p>
											</div>
											<div class="join-us" data-animation="animate__fadeInUp" data-delay="0.6s">
												<a class='e-primary-btn has-icon' href='about.php'>
					...
					<div class="swiper-slide">
						<div class="hero-side" style="background-image: url(assets/img/home/hero/hero11.webp)"
							fetchpriority="high">
							<div class="container">
								<div class="row">
									<div class="col-xl-12">
										<div class="hero-content-1">
											...
											<div class="text" data-animation="animate__fadeInUp" data-delay="0.5s">
												<p><?php echo frontend_escape($contentText('home.hero.slide4.text')); ?>
												</p>
											</div>
											<div class="join-us" data-animation="animate__fadeInUp" data-delay="0.6s">
												<a class='e-primary-btn has-icon' href='about.php'>
		...
		<section class="about-us-section m-t-100 m-t-md-100 m-t-xs-80">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-xl-6">
						<div class="shape-wrapped-thumb-1" data-aos="fade-up" data-aos-duration="1000"
							data-aos-delay="200">
							<img src="assets/img/home/about/about2.webp" alt="thumb" />
							...
							<div class="positioned-shape">
								<div class="shape-wrapped-thumb-2">
									<div class="video-thumb">
										<img src="assets/img/home/about/about4.webp" alt="thumb" />
					...
					<div class="col-xl-6">
						<div class="about-us-content px-xxl-5 px-3" data-aos="fade-up" data-aos-duration="1000"
							data-aos-delay="400">
							...
							<div class="c-tabs-wrapper">
								...
								<div class="tab-content" id="myTabContent">
									<div class="tab-pane fade show active" id="c-tab-1-pane" role="tabpanel"
										...
										<div class="text">
											<p><?php echo frontend_escape($contentText('home.about.tabs.tab1.text')); ?>
											</p>
										</div>
										<div class="benefits">
											<ul>
									...
									<div class="tab-pane fade" id="c-tab-2-pane" role="tabpanel"
										...
										<div class="text">
											<p><?php echo frontend_escape($contentText('home.about.tabs.tab2.text')); ?>
											</p>
										</div>
										<div class="benefits">
											<ul>
									...
									<div class="tab-pane fade" id="c-tab-3-pane" role="tabpanel"
										...
										<div class="text">
											<p><?php echo frontend_escape($contentText('home.about.tabs.tab3.text')); ?>
											</p>
										</div>
										<div class="benefits">
											<ul>
							...
							<div class="annual-donation-wrap about-us-cta-group">
								<a class='e-primary-btn has-icon' href='about.php'>
			...
			<div class="container">
				<div class="company-achievements" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
					<div class="achievement">
						...
						<h2>
							<span class="purecounter" data-purecounter-duration="2"
								data-purecounter-end="50">50</span>k+
						</h2>
					...
					<div class="achievement">
						...
						<h2>
							<span class="purecounter" data-purecounter-duration="2"
								data-purecounter-end="500">500</span>+
						</h2>
		...
		<section class="what-we-do-section-2">
			<div class="container">
				<div class="row">
					<div class="col-xl-12">
						<div class="section-top-3">
							<div class="left">
								<div class="common-subtitle" data-aos="fade-up" data-aos-delay="200"
									data-aos-duration="1000">
									<img alt="icon-2" src="assets/img/icons/wheat.png" class="wheat-icon">
									<span><?php echo frontend_escape($contentText('home.grassroots.sectionSubtitle')); ?></span>
								</div>
								<div class="common-title text-start" data-aos="fade-up" data-aos-delay="400"
									data-aos-duration="1000">
									<h2><?php echo frontend_escape($contentText('home.grassroots.sectionTitle')); ?>
									</h2>
								</div>
							</div>
							<div class="right" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
								<p><?php echo frontend_escape($contentText('home.grassroots.quote')); ?></p><a
									class='service-btn e-primary-btn has-icon'
									href='contact.php'><?php echo frontend_escape($contentText('home.grassroots.cta')); ?>
									<span class="icon-wrap"><span class="icon"><i class="fa-regular fa-arrow-right"></i>
											<i class="fa-regular fa-arrow-right"></i></span></span></a>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-xl-12">
						<div class="whatwedo-slider-active" data-aos="fade-up" data-aos-delay="800"
							data-aos-duration="1000">
							<div class="swiper">
								<div class="swiper-wrapper">
										...
										<div class="swiper-slide">
											<div class="we-do-card">
												<div class="card-content">
													<i
														class="fa-solid fa-sun"><span><?php echo frontend_escape((string) ($index + 1)); ?></span></i>
													<h5><?php echo frontend_escape($cardTitle); ?></h5>
												</div>
												<div class="card-thumb">
													<img alt="thumb"
														src="assets/img/home/public-meetings/meeting<?php echo frontend_escape((string) ($index + 1)); ?>.webp">
												</div>
											</div>
										</div>
									<?php endforeach; ?>
				...
				<div class="row row-gap-5">
					<div class="col-xl-6" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
						<div class="friends-left">
							...
							<div class="blog-btn">
								<a class='e-primary-btn has-icon'
									href='contact.php'><?php echo frontend_escape($contentText('home.leadership.cta')); ?>
									<span class="icon-wrap"><span class="icon"><i class="fa-regular fa-arrow-right"></i>
											<i class="fa-regular fa-arrow-right"></i></span></span></a>
							</div>
							<div class="top-right">
								...
								<div class="people-joined">
									<h5>50k+</h5>
									<span><?php echo frontend_escape($contentText('home.leadership.supporters.label')); ?></span>
								</div>
							</div>
					...
					<div class="col-xl-6" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
						<div class="friends-card m-b-20">
							<div class="row">
								<div class="col-md-12">
									<div class="thumb">
										<img alt="thumb" src="assets/img/home/senior-citizens/leader1.webp">
									</div>
								</div>
							</div>
						</div>
						<div class="friends-card m-b-20">
							<div class="row">
								<div class="col-md-12">
									<div class="thumb">
										<img alt="thumb" src="assets/img/home/senior-citizens/leader2.webp">
									</div>
								</div>
							</div>
						</div>
						<div class="friends-card m-b-20">
							<div class="row">
								<div class="col-md-12">
									<div class="thumb">
										<img alt="thumb" src="assets/img/home/senior-citizens/leader4.webp">
									</div>
								</div>
							</div>
						</div>
						<div class="friends-card">
							<div class="row">
								<div class="col-md-12">
									<div class="thumb">
										<img alt="thumb" src="assets/img/home/senior-citizens/leader5.webp">
									</div>
								</div>
							</div>
						</div>
						<div class="friends-card">
							<div class="row">
								<div class="col-md-12">
									<div class="thumb">
										<img alt="thumb" src="assets/img/home/senior-citizens/leader9.webp">
									</div>
								</div>
							</div>
						</div>
						<div class="friends-card">
							<div class="row">
								<div class="col-md-12">
									<div class="thumb">
										<img alt="thumb" src="assets/img/home/senior-citizens/leader10.webp">
									</div>
								</div>
							</div>
						</div>
		...
		<section class="services-we-offer-section p-t-100 p-b-100 p-t-xs-80 p-b-xs-80"
			style="background-image: url('assets/img/bg/services-we-offer-bg.webp')">
			<div class="container">
				<div class="text-center m-b-50 m-b-xs-40">
					<div class="common-subtitle" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
						<img alt="icon-2" src="assets/img/icons/wheat.png" class="wheat-icon">
						<span><?php echo frontend_escape($contentText('home.workSection.sectionSubtitle')); ?></span>
					</div>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="service-slider-active" data-aos="fade-up" data-aos-delay="600"
							data-aos-duration="1000">
							<div class="swiper">
								<div class="swiper-wrapper">
									<?php foreach ($homeOurWorkItems as $item): ?>
										...
										<div class="swiper-slide">
											<div class="service-card-3">
												<div class="thumb">
													<a><img alt="thumb"
															src="<?php echo frontend_escape($workThumb); ?>"></a>
												</div>
											</div>
										</div>
									<?php endforeach; ?>
		...
		<section class="services-section-2 p-t-100 p-t-xs-80">
			<div class="container">
				<div class="services-content">
					<div class="text-center m-b-50 m-b-xs-40">
						<div class="common-subtitle" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
							<img alt="icon" src="assets/img/icons/icon-9.svg">
							<span><?php echo frontend_escape($contentText('home.joinUs.sectionSubtitle')); ?></span>
						</div>
						<div class="common-title m-b-0" data-aos="fade-up" data-aos-delay="400"
							data-aos-duration="1000">
							<h2><?php echo frontend_escape($contentText('home.joinUs.sectionTitle')); ?></h2>
						</div>
					</div>
					<div class="row row-gap-4 m-b-135 m-b-lg-120 m-b-md-100 m-b-xs-80" data-aos="fade-up"
							...
							<div class="service-card-2">
								<div class="service-top">
									...
									<div class="join-utility join-qr">
										<img src="https://quickchart.io/qr?size=170&text=https%3A%2F%2Fchat.whatsapp.com%2F"
											alt="WhatsApp community QR" loading="lazy">
									</div>
								</div>
							...
							<div class="service-card-2">
								<div class="service-top">
									...
									<div class="join-utility join-social-links">
										<a href="https://www.instagram.com/vidhayak_yogeshnauhwar/" target="_blank"
											rel="noopener" aria-label="Instagram">
											<i class="fab fa-instagram"></i>
										</a>
										<a href="https://www.facebook.com/ChaudharyYN/" target="_blank" rel="noopener"
											aria-label="Facebook">
											<i class="fab fa-facebook-f"></i>
										</a>
									</div>
						...
						<div class="col-xl-4 col-md-6">
							<div class="service-card-2">
								<div class="service-top">
									...
									<div class="join-utility join-qr">
										<img src="./assets/img/logo/rld-membership.png" alt="RLD membership QR"
											loading="lazy">
									</div>
								</div>
								<div class="service-content">
		...
		<section class="latest-work-section mt-0 p-t-50 p-b-100 p-t-xs-80 p-b-xs-80">
			<div class="container">
				<div class="text-center m-b-60 m-b-xs-50">
					<div class="common-subtitle" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
						<img alt="icon" src="assets/img/icons/icon-9.svg">
						<span><?php echo frontend_escape($contentText('home.events.sectionSubtitle')); ?></span>
					</div>
					<div class="common-title m-b-0" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
						...
						<?php foreach ($homeRecentEvents as $index => $event): ?>
							...
							<div class="work-card">
								<div class="work-card-thumb">
										...
										<svg class="clippy">
											<defs>
												<clippath id="w-mask-image">
													<path
														d="M94.208 5.66961L19.4714 50.3601C7.39412 57.582 0 70.6187 0 84.6905V542.872H499.787V138.759C499.787 124.827 492.537 111.898 480.65 104.631L319.1 5.87191C312.818 2.0319 305.599 0 298.236 0H114.737C107.507 0 100.413 1.95932 94.208 5.66961Z"
														fill="#FFE175"></path>
												</clippath>
									...
									<?php endif; ?>
									<img alt="<?php echo ($eventTitle); ?>" src="<?php echo ($eventThumb); ?>">
								</div>
								<div class="work-card-content">
									...
									<div class="annual-donation-wrap">
										<div class="blog-btn">
											<a class='e-primary-btn has-icon is-hover-white'
												href='events.php'><?php echo frontend_escape($contentText('home.events.cta')); ?>
												<span class="icon-wrap"><span class="icon"><i
															class="fa-regular fa-arrow-right"></i> <i
			...
			<div class="container">
				<div class="row align-items-center justify-content-between">
					<div class="col-xl-4 m-b-lg-60 m-b-md-60 m-b-xs-60">
						<div class="testimonial-content" data-aos="fade-up" data-aos-delay="200"
							data-aos-duration="1000">
							<div class="common-subtitle">
								<img alt="icon-2" src="assets/img/icons/wheat.png" class="wheat-icon">
								<span><?php echo frontend_escape($contentText('home.testimonials.sectionSubtitle')); ?></span>
							</div>
							<div class="common-title text-start">
							...
							<div class="reviews">
								<h3>
									<span class="purecounter" data-purecounter-duration="1"
										data-purecounter-end="99">0</span>%
									<!-- </h3><img alt="favicon" src="assets/img/logo/favicon.webp"> -->
									<h5><?php echo frontend_escape($contentText('home.testimonials.positiveReviews.label')); ?>
									</h5>
							</div>
					...
					<div class="col-xl-8">
						<div class="testimonial-slider-active" data-aos="fade-up" data-aos-delay="400"
							data-aos-duration="1000">
							<div class="swiper">
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="testimonial-card">
											<div class="thumb">
												<img alt="thumb-10"
													src="assets/img/home/testimonials/yugal-lawaniya.webp">
												<!-- <a class="video-play-btn" data-fancybox="" href="https://www.youtube.com/watch?v=fLeJJPxua3E&amp;ab_channel=Motiversity">Play</a> -->
											</div>
											<div class="card-content">
												<div class="rating">
													<p><?php echo frontend_escape($contentText('home.testimonials.ratingLabel')); ?>
													</p><i class="fa-solid fa-star-sharp"></i> <span>5.0</span>
												</div>
												<div class="review">
													<p><?php echo frontend_escape($contentText('home.testimonials.items.0.review')); ?>
													</p>
												</div>
												<div class="author-details">
													<h5><?php echo frontend_escape($contentArray('home.testimonials.items')[0]['name'] ?? ''); ?>
													</h5>
													<!-- <h6>Village elder</h6> -->
												</div>
											</div>
									...
									<div class="swiper-slide">
										<div class="testimonial-card">
											<div class="thumb">
												<img alt="thumb-10"
													src="assets/img/home/testimonials/vikas-chaudhary.webp">
												<!-- <a class="video-play-btn" data-fancybox="" href="https://www.youtube.com/watch?v=fLeJJPxua3E&amp;ab_channel=Motiversity">Play</a> -->
											</div>
											<div class="card-content">
												<div class="rating">
												...
												<div class="review">
													<p><?php echo frontend_escape($contentText('home.testimonials.items.1.review')); ?>
													</p>
												</div>
												<div class="author-details">
													<h5><?php echo frontend_escape($contentArray('home.testimonials.items')[1]['name'] ?? ''); ?>
													</h5>
													<!-- <h6>Sr. Volunteer</h6> -->
												</div>
											</div>
									...
									<div class="swiper-slide">
										<div class="testimonial-card">
											<div class="thumb">
												<img alt="thumb-10"
													src="assets/img/home/testimonials/kush-chaudhary.webp">
												<!-- <a class="video-play-btn" data-fancybox="" href="https://www.youtube.com/watch?v=fLeJJPxua3E&amp;ab_channel=Motiversity">Play</a> -->
											</div>
											<div class="card-content">
												<div class="rating">
												...
												<div class="review">
													<p><?php echo frontend_escape($contentText('home.testimonials.items.2.review')); ?>
													</p>
												</div>
												<div class="author-details">
													<h5><?php echo frontend_escape($contentArray('home.testimonials.items')[2]['name'] ?? ''); ?>
													</h5>
													<!-- <h6>Sr. Volunteer</h6> -->
												</div>
											</div>
									...
									<div class="swiper-slide">
										<div class="testimonial-card">
											<div class="thumb">
												<img alt="thumb-10"
													src="assets/img/home/testimonials/sachin-chaudhary.webp">
												<!-- <a class="video-play-btn" data-fancybox="" href="https://www.youtube.com/watch?v=fLeJJPxua3E&amp;ab_channel=Motiversity">Play</a> -->
											</div>
											<div class="card-content">
												<div class="rating">
												...
												<div class="review">
													<p><?php echo frontend_escape($contentText('home.testimonials.items.3.review')); ?>
													</p>
												</div>
												<div class="author-details">
													<h5><?php echo frontend_escape($contentArray('home.testimonials.items')[3]['name'] ?? ''); ?>
													</h5>
													<!-- <h6>Sr. Volunteer</h6> -->
												</div>
											</div>
									...
									<div class="swiper-slide">
										<div class="testimonial-card">
											<div class="thumb">
												<img alt="thumb-10"
													src="assets/img/home/testimonials/aman-upadhyay.webp">
												<!-- <a class="video-play-btn" data-fancybox="" href="https://www.youtube.com/watch?v=fLeJJPxua3E&amp;ab_channel=Motiversity">Play</a> -->
											</div>
											<div class="card-content">
												<div class="rating">
												...
												<div class="review">
													<p><?php echo frontend_escape($contentText('home.testimonials.items.4.review')); ?>
													</p>
												</div>
												<div class="author-details">
													<h5><?php echo frontend_escape($contentArray('home.testimonials.items')[4]['name'] ?? ''); ?>
													</h5>
													<!-- <h6>Village elder</h6> -->
												</div>
											</div>
		...
		<section class="completed-project-section">
				...
				<div class="container">
					<div class="row align-items-end m-b-60 m-b-xs-40">
						<div class="col-xl-6 col-lg-6 col-md-7">
							<div class="common-subtitle style-color-2" data-aos="fade-up" data-aos-delay="200"
								data-aos-duration="1000">
								<img alt="icon-2" src="assets/img/icons/wheat.png" class="wheat-icon">
								<span><?php echo frontend_escape($contentText('home.mediaCoverage.sectionSubtitle')); ?></span>
							</div>
							<div class="common-title media-coverage style-color-light text-start m-b-0"
						...
						<div class="col-xl-6 col-lg-6 col-md-5 text-md-end">
							<a class='e-primary-btn is-hover-white has-icon' data-aos-delay='600'
								data-aos-duration='1000' data-aos='fade-up'
								href='media-coverage.php'><?php echo frontend_escape($contentText('home.mediaCoverage.cta')); ?>
			...
			<div class="completed-project-bottom">
				<div class="completed-project-slider-active" data-aos="fade-up" data-aos-delay="800"
					data-aos-duration="1000">
					<div class="swiper">
						<div class="swiper-wrapper">
							<?php foreach ($homeMediaCoverage as $item): ?>
								...
								<div class="swiper-slide">
									<div class="project-card">
										<div class="thumb">
											<a href='media-coverage.php'><img alt="<?php echo frontend_escape($altText); ?>"
													src="<?php echo frontend_escape($thumb); ?>"></a>
										</div>
									</div>
								</div>
							<?php endforeach; ?>
			...
			<div class="container">
				<div class="row faq">
					<div class="col-xl-6" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
						<div class="accordion faq-accordion" id="accordionFlushExample">
							<div class="accordion-item">
								<h2 class="accordion-header"><button aria-controls="flush-collapseOne"
										aria-expanded="false" class="accordion-button collapsed"
										data-bs-target="#flush-collapseOne" data-bs-toggle="collapse"
										type="button"><span
											class="accordion-title">1.</span><?php echo frontend_escape($contentText('home.faq.items.0.question')); ?>
										<span class="icon"><span class="icon-plus"></span> <span
												class="icon-minus"></span></span></button></h2>
							...
							<div class="accordion-item">
								<h2 class="accordion-header"><button aria-controls="flush-collapseTwo"
										aria-expanded="false" class="accordion-button collapsed"
										data-bs-target="#flush-collapseTwo" data-bs-toggle="collapse"
										type="button"><span
											class="accordion-title">2.</span><?php echo frontend_escape($contentText('home.faq.items.1.question')); ?>
										<span class="icon"><span class="icon-plus"></span> <span
												class="icon-minus"></span></span></button></h2>
								<div class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample"
							...
							<div class="accordion-item">
								<h2 class="accordion-header"><button aria-controls="flush-collapseThree"
										aria-expanded="false" class="accordion-button"
										data-bs-target="#flush-collapseThree" data-bs-toggle="collapse"
										type="button"><span class="accordion-title">3.</span>
										<?php echo frontend_escape($contentText('home.faq.items.2.question')); ?> <span
											class="icon"><span class="icon-plus"></span> <span
												class="icon-minus"></span></span></button></h2>
							...
							<div class="accordion-item">
								<h2 class="accordion-header"><button aria-controls="flush-collapseFour"
										aria-expanded="false" class="accordion-button collapsed"
										data-bs-target="#flush-collapseFour" data-bs-toggle="collapse"
										type="button"><span
											class="accordion-title">4.</span><?php echo frontend_escape($contentText('home.faq.items.3.question')); ?>
										<span class="icon"><span class="icon-plus"></span> <span
												class="icon-minus"></span></span></button></h2>
								<div class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample"
							...
							<div class="accordion-item">
								<h2 class="accordion-header"><button aria-controls="flush-collapseFive"
										aria-expanded="false" class="accordion-button collapsed"
										data-bs-target="#flush-collapseFive" data-bs-toggle="collapse"
										type="button"><span
											class="accordion-title">5.</span><?php echo frontend_escape($contentText('home.faq.items.4.question')); ?>
										<span class="icon"><span class="icon-plus"></span> <span
												class="icon-minus"></span></span></button></h2>
								<div class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample"
					...
					<div class="col-xl-5" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
						<div class="common-subtitle">
							<img alt="icon-2" src="assets/img/icons/wheat.png" class="wheat-icon">
							<span><?php echo frontend_escape($contentText('home.faq.sectionSubtitle')); ?></span>
						</div>
						<div class="common-title text-start">
						...
						<div class="blog-btn">
							<a class='e-primary-btn has-icon'
								href='contact.php'><?php echo frontend_escape($contentText('home.faq.cta')); ?> <span
						...
						<div class="top-right">
							...
							<div class="people-joined">
								<h5>50k+</h5>
								<span><?php echo frontend_escape($contentText('home.hero.supporters.label')); ?></span>
							</div>
						</div>
					</div>
				</div>
