				...
				<div class="col-xl-12 col-lg-12">
					<div class="breadcrumb-content">
						<div class="breadcrumb-nav" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
							<ul>
								<li><a href='index.php'><?php echo frontend_escape($contentText('about.breadcrumb.home')); ?></a></li>
								<li><a href="about.php"><?php echo frontend_escape($contentText('about.breadcrumb.about')); ?></a></li>
							</ul>
						</div>
				...
				<div class="col-xl-6">
					<div class="thumb" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
						<div class="shape-wrapped-thumb-2">
							<div class="thumb-wrapper"> <img alt="thumb" src="assets/img/about/about1.webp"></div>
			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="col-xl-6">
					<div class="history-image-wrap" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
						<img src="assets/img/about/about2.webp" alt="Our history"/>
					</div>
				</div>
			</div>
		</div>
